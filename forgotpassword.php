								...
								<div class="form-group">
									...
									<button type="submit" class="btn pull-right" name="btn-forgot"  onClick="FetchDetails();">
										Continue
                                            ...
                                            <div class="basic-login form-group" id="emailDiv" style="display:none;">
...
//                                        alert(values[4]);
                                        if(values[4]!=''){
                                        $("#emailDiv").html('A password recovery email has been sent to registered Email ID. Please click on the password recovery link sent to your email to reset your password.');
