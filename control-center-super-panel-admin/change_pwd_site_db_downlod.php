...
// 	header('Location:'.$_SERVER['HTTP_REFERER']);
	...
	if(isset($_POST['update']))
	{
	    ...
	    $query = 'UPDATE site_db_download_config SET username="'.$_POST['username'].'", password="'.md5(trim($_POST['password'])).'" where '.$where;
...
$where = "id = 1" ;
$user = $BaseClassObject->getAllData('site_db_download_config',$where);
?>
      ...
      <div class="col-xs-12">
        <div class="box">
			<div class="box-header"> 
				<span><h1 class="box-title"><b>Site Download Change Password </b></h1></span>
				<span style="float: right;"><a href="change_pwd_site_db_downlod.php" class="btn btn-primary">Back</a></span>
			</div>
			<?php 
			  if(isset($error))
			  {
			...
			?>
			<div class="box-body ">
			<form class="form-horizontal" action="change_pwd_site_db_downlod.php" method="post">
                     ...
                     User Name</label>
                       <div class="col-xs-10 col-lg-10 col-sm-8">
                           <input class="form-control" id="username" type="text" placeholder="Enter User Name" required="" name="username" autocomplete="off" value="<?php echo $value['username'];?>">
