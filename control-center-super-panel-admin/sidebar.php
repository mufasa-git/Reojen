        ...
        ?>
          ...
          <a href="">
            ...
            <span>Send Message</span>            
                ...
                <li class="treeview <?php if($uri_segments[2]=='change_currency.php'){echo 'active open'; }else{ } ?>">
                    <a href="change_currency.php">
                        <i class="fa fa-gbp"></i></i><span>Change currency</span>
                    </a>
                </li>
...
<!--
Commented By Abhishek 11-Sep-2018
-->
<!--
                    <a href="http://139.59.163.223/control-center-super-panel-admin/site_download/" target="_blank">
-->
                        <a href="<?php $_SERVER['SERVER_NAME']?> /control-center-super-panel-admin/site_download/" target="_blank">
